...
Background:
    Given there are the following users:
        ...
        | user@ticketee.com.tw  | password  | false |
        | admin@ticketee.com.tw | password  | true  |
...
Scenario: New project link is hidden for signed-in users
    Given I am signed in as "user@ticketee.com.tw"
    Then I should not see the "New Project" link
    
Scenario: New project link is shown to admins
    Given I am signed in as "admin@ticketee.com.tw"
